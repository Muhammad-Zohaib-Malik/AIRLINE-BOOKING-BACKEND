...
export const getAllCities = asyncHandler(async (_, res) => {
  ...
  return res
    ...
    .json(new ApiResponse(StatusCodes.OK, city, "City retrieved successfully"));
});
  ...
  return res
    ...
    .json(
      new ApiResponse(
        StatusCodes.OK,
        city,
        "city  and related airports deleted successfully"
      )
    );
});
...
export const updateCityById = asyncHandler(async (req, res) => {
  ...
  return res
    .status(StatusCodes.OK)
    .json(new ApiResponse(StatusCodes.OK, city, "city updated successfully"));
});
