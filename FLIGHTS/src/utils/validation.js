...
export const airplaneSchema = z.object({
  ...
  modelNumber: z
    .string()
    .trim()
    .min(1, "Model number is required and must be a string"),
  seatingCapacity: z
    .number()
...
export const flightSchema = z.object({
  flightNumber: z
    .string()
    .trim()
    .min(1, "Flight number is required and must be a string"),
  airplaneId: z.string().length(24, "Airplane ID must be a valid ObjectId"),
  departureAirportId: z
    .string()
    .length(24, "Departure Airport ID must be a valid ObjectId"),
  arrivalAirportId: z
    .string()
    .length(24, "Arrival Airport ID must be a valid ObjectId"),
  ...
  totalSeats: z.object({
    economy: z
      .number()
      .positive("Total economy seats must be a positive number"),
    business: z
      .number()
